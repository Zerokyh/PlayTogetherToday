  ...
  return (
    <React.Fragment>
      <Select
        ...
        defaultValue={0}
      >
        <Option className="CustomSelectIntroduction-option hidden" value={0}>
          카테고리
        </Option>
        <Option className="CustomSelectIntroduction-option" value={1}>
          운동/스포츠
        </Option>
        <Option className="CustomSelectIntroduction-option" value={2}>
          외국/언어
        </Option>
        <Option className="CustomSelectIntroduction-option" value={3}>
          문화/공연/축제
        </Option>
        <Option className="CustomSelectIntroduction-option" value={4}>
          음악/악기
        </Option>
      </Select>
      <Styles />
